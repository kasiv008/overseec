...
def sam_refiner_image_embedding(
                sam_input_image,
    ...
    for i in range(iters):
        ...
        input_dict, point_coords = sam_input_prepare(sam_input_image[0],
                                                     pred_mask_list,
                                                     sam_image_embeddings,
                                                     resize_transform,
                                                     use_point=use_point,
        ...
        sam_output = sam.forward_with_image_embeddings(sam_image_embeddings, sam_input, multimask_output=True)[0] #dict_keys(['masks', 'iou_predictions', 'low_res_logits'])
